...
function CategoryPanel({
  ...
  // A brand-new top-level category must never end up with a parent, even
  // by accident -- so the parent selector simply isn't offered here at
  // all (this used to render for "add-parent" too, which is how a new
  // "parent" category could silently end up nested under whatever was
  // selected in the sidebar at the time).
