...
export function AuthHeroPanel() {
  return (
    <div className="relative hidden w-1/2 flex-shrink-0 items-center justify-center overflow-hidden bg-gradient-to-br from-primary/20 via-background to-highlight/10 lg:flex">
      ...
      <div className="relative z-10 animate-float">
        <Image
          ...
          width={480}
          height={720}
          className="max-h-[85vh] w-auto drop-shadow-2xl"
          priority
        />
      </div>
    </div>
