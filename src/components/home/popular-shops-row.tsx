  ...
  return (
    <div className="mb-8">
      ...
      <div className="no-scrollbar -mx-4 flex gap-4 overflow-x-auto px-4 md:-mx-6 md:px-6">
        {shops.map((s) => (
          <Link key={s.slug} href={`/store/${s.slug}`} className="flex w-20 flex-shrink-0 flex-col items-center gap-1.5 text-center">
            ...
            <p className="w-full truncate text-xs font-medium text-white/70">{s.store_name}</p>
